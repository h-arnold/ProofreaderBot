...
---
## `manage_language_ignore.py` Docs
...
[{
  ````chatmode
  ---
  description: "False-positive identification & batch curation for DEFAULT_IGNORED_WORDS"
  tools: []
  ---
...
- If you need to raise the maximum allowed word length, update the config first (see repo docs) before applying.
  ...
  - "glutenfree" (incorrect compound word - should be hyphenated or separated)
