...
### If doing anything outside of `./site` (i.e. not the GitHub Pages Site)
...
### If doing anything *inside* of `./site` (.i.e. doing something with the GitHub pages site)

Check `./site/README.md` for more details.
