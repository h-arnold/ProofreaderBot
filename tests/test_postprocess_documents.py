...
class TestProcessSinglePdf:
    ...
    def test_processes_pdf_in_root_of_subject(
        self, temp_docs_dir, sample_pdf, mock_converter
    ):
    ...
    def test_processes_pdf_already_in_pdfs_subdir(
        self, temp_docs_dir, sample_pdf, mock_converter
    ):
    ...
    def test_creates_directories_if_needed(
        self, temp_docs_dir, sample_pdf, mock_converter
    ):
