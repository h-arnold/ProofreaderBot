...
from src.llm.provider_registry import create_provider_chain, _split_names, _PROVIDER_FACTORIES
...
def mock_provider_factory(name: str):
    ...
    def factory(*, system_prompt: str | Path, filter_json: bool, dotenv_path: str | Path | None):
