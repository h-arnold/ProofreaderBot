...
def test_gemini_reads_min_interval_from_env(
...
def test_gemini_raises_quota_error_immediately_on_resource_exhausted(
    tmp_path: Path,
) -> None:
...
def test_gemini_reads_max_retries_from_env(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
