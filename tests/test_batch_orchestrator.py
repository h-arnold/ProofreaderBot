...
def test_batch_orchestrator_process_batch_response_validates_correctly(
    tmp_path: Path,
) -> None:
...
def test_batch_orchestrator_process_batch_response_filters_invalid(
    tmp_path: Path,
) -> None:
...
def test_batch_orchestrator_process_batch_response_handles_non_list(
    tmp_path: Path,
) -> None:
