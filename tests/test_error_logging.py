...
class TestPostprocessingErrorLogging:
    ...
    def test_process_single_pdf_logs_conversion_error_with_traceback(self, tmp_path, capture_logs):
    ...
    def test_process_single_pdf_logs_copy_error_with_traceback(self, tmp_path, capture_logs):
    ...
    def test_process_subject_logs_conversion_errors_with_traceback(self, tmp_path, capture_logs):
...
class TestProcessAllSubjectsErrorLogging:
    ...
    def test_process_pdf_file_logs_exception_with_traceback(self, tmp_path, capsys):
        ...
        with patch("src.postprocessing.process_single_pdf", side_effect=ValueError("Test exception")):
    ...
    def test_process_subject_subprocess_logs_exception_with_traceback(self, tmp_path, capsys):
        ...
        with patch("process_all_subjects.subprocess.Popen", side_effect=OSError("Command not found")):
            result = process_subject("Test-Subject", docs_dir, "markitdown", "uv run python", cwd)
...
class TestCopyRootPdfsErrorLogging:
    ...
    def test_copy_root_pdfs_logs_copy_errors_with_traceback(self, tmp_path, capture_logs):
    ...
    def test_copy_root_pdfs_logs_unlink_errors_with_traceback(self, tmp_path, capture_logs):
