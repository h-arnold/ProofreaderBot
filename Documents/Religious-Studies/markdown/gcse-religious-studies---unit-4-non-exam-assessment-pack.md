...
Unit 4: Religion and human rights Teaching from 2025 For award from 2027
...
- 30 minutes completing task 1
- 1 hour 30 minutes completing task 2
- 1 hour 30 minutes completing task 3
- 1 hour 30 minutes completing task 4
- 1 hour completing task 5
...
One level of resources features throughout the assessment:

![](_page_5_Picture_3.jpeg)

Permitted resources are clearly noted for each task; teachers must ensure that only the permitted resources noted are used.

Teachers must check that any permitted resources that learners take into the tasks do not include pre-prepared answers to use for completion of the tasks.
...
Each task notes the applicable level of supervision; teachers **must** ensure that the correct level of supervision is applied to each task.
...
Candidates must sign the declaration to confirm that all evidence submitted for marking is their own work and that any sources used have been acknowledged.

Teachers must sign the declaration to confirm that evidence submitted for moderation was completed under the controlled conditions set out in this assessment.
...
You must select **two** of the three human rights issues selected by WJEC on which to base your investigation.
...
This candidate assessment pack is for candidates completing Unit 4: Religion and Human Rights
...
- select charities or organisations whose purpose and aims reflect the human rights issues selected
- summarise the relevant articles of the Universal Declaration of Human Rights, and the relevant beliefs, teachings, practices and perspectives of the two religions you have studied, and non-religious perspectives
- analyse, evaluate and make justified conclusions based on a range of perspectives in relation to the importance of the human rights issues selected to society today
- reflect on your own values and beliefs in relation to the charities or organisation selected.

#### Before undertaking the non-examination assessment (pre-assessment period)

Before undertaking the tasks, you must ensure you have the following information relating to the **two** human rights issues you have selected:

- the relevant beliefs, teachings, practices and perspectives from the **two** religions you have studied
- relevant non-religious perspectives
- details of relevant articles of the Universal Declaration of Human Rights (there may be more than one per human rights issue, you should not include more than 5).

You are permitted to take a maximum of six sides of A4 written or typed notes from your preassessment period work into your non-examination assessment. These notes must not contain prepared responses to tasks and **must** be submitted alongside your work.
...
You must select **two** local, national or global charities or organisations who campaigns for a human rights issues selected. For **each** human rights issue selected, you must select one local, national or global charity or organisation who works to campaigns for that particular human rights issue.

You must research information on both charities or organisations, including their aims and work.

This research does not form part of the non-examination time.

You are permitted to take a maximum of four sides of A4 written or typed research notes you have selected into your assessment. These research notes **must** be submitted alongside the response to the tasks.
...
Write a rationale to support the selection of each of your **two** charities or organisations based on the following:
...
Based on the first human rights issue selected, write a summary of:

- a) the relevant articles of the Universal Declaration of Human Rights
- b) how the work of the first charity or organisation aligns with the relevant articles of the Universal Declaration of Human Rights
...
Based on the second human rights issue selected, write a summary of:

- a) the relevant articles of the Universal Declaration of Human Rights
- b) how the work of the second charity or organisation aligns with the relevant articles of the Universal Declaration of Human Rights
- c) relevant beliefs, teachings, practices and perspectives from the **two** religions you have studied
- d) relevant non-religious perspectives [15 marks]
...
Analyse and evaluate which of the two Human Rights issues selected is more important to society today.

In your answer, refer to the points below and come to a justified conclusion:
